...
export const env = createEnv({
  ...
  runtimeEnv: {
    PUBLIC_API_URL: Bun.env.NEXT_PUBLIC_API_URL,
    PUBLIC_PUSHER_APP_KEY: Bun.env.NEXT_PUBLIC_PUSHER_APP_KEY,
    PUBLIC_PUSHER_APP_CLUSTER: Bun.env.NEXT_PUBLIC_PUSHER_APP_CLUSTER,
    PUBLIC_PUSHER_HOST: Bun.env.NEXT_PUBLIC_PUSHER_HOST,
    PUBLIC_PUSHER_PORT: Bun.env.NEXT_PUBLIC_PUSHER_PORT,
    PUBLIC_PUSHER_USE_TLS: Bun.env.NEXT_PUBLIC_PUSHER_USE_TLS,
    PUBLIC_NODE_ENV: Bun.env.NEXT_PUBLIC_NODE_ENV,
  },
})
