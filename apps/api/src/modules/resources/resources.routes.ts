import { PaginationSchema } from '@questpie/api/common/common.schemas'
import { injectDatabase } from '@questpie/api/db/db.client'
import { organizationMiddleware } from '@questpie/api/modules/organizations/organizations.middleware'
import { injectResourcesService } from '@questpie/api/modules/resources/services/resources.service'
import { ResourceSchema } from '@questpie/shared/modules/resources/resources.schemas'
